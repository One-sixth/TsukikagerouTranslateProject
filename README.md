...
目前已有的贡献人员，OMX, 鱊之不一, 心, 落果糜烂, PMM, 查拉图斯特拉，美咕噜  
非常感谢他们!  
...
# 第九步，更新翻译（新的小节翻译方式，2024-1-27 新增）
## 注意先把你的 cache_tr.json 文件备份一份，便于修改错地方导致无法封包。
以 月阳炎 为例子
找到文件夹 3-2.月阳炎-导出的文本-原始 和 3-2.月阳炎-导出的文本-翻译后  
3-2.月阳炎-导出的文本-原始 存放着原始日文文本  
3-2.月阳炎-导出的文本-翻译后 存放着初步翻译后的文本  
你要修改的是 3-2.月阳炎-导出的文本-翻译后 里面的文件，每个文件都是一个剧情小节  
内容是null 的行不要做任何改动，要改动的是有汉字的行，把错误的，不连续的翻译改成正确的。  
注意不要弄坏文件结构。  
当你修正完后，保存。  
